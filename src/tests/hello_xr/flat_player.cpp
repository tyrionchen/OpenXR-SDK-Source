...
struct FlatPlayer: public IPlayer {

  FlatPlayer(const std::array<float, 4> color) :
      m_clearColor(color) {
  }
  ...
  //        XrMatrix4x4f_Multiply(&vp, &proj, &view);
      ...
      // TODO
      // 以上是计算View Projection
      // 矩阵需要再加上一个球体的位置 Model
  ...
  void InitializeResources() override {
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(Geometry::c_2dPlayer_texture_vertices), Geometry::c_2dPlayer_texture_vertices, GL_STATIC_DRAW);
